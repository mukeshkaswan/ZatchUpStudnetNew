...
import { Text, View, StyleSheet, Image, TouchableOpacity, KeyboardAvoidingView, Dimensions, ScrollView, BackHandler } from 'react-native';
...
interface AddCourseDetailsOthersScreenProps { navigation: any, route: any }
...
const AddCourseDetailsOthers = (props: AddCourseDetailsOthersScreenProps) => {
    ...
    const CourseAdded = async () => {
        ...
        const dobErrorend = Validate("enddate", date_copy1);
        const desError = Validate("Des", Des);


        if (
            coursenameError ||
            courseError || dobError || dobErrorend || desError
        ) {
            //this._scrollView.scrollTo(0);
            Toast.show(coursenameError || courseError || dobError || dobErrorend || desError, Toast.SHORT);
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <View style={{ marginTop: '5%' }}>
                            <TouchableOpacity onPress={showDatepicker}>
                                ...
                                <View style={{}}>
                                    <TextField placeholder={'Course Up from'}
                        ...
                        <TouchableOpacity onPress={showDatepicker1}>
                            ...
                            <View style={{ marginTop: '5%', }}>
                                <TextField placeholder={'Course Up to'}
                                    imageIcon={Images.calendar_icon}
                        ...
                        <View style={{ marginTop: '5%', marginLeft: 2, marginRight: 2, marginBottom: '5%' }}>
                            ...
                            <TextField placeholder={'Add Description of Study...'} multiline={true} onChangeText={val => setDes(val)} value={Des}
                            />
                        </View>
                        ...
                        <View>
                            <CustomButton title={'Add'} onPress={() => CourseAdded()}
