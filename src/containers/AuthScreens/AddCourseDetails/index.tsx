...
interface AddCourseDetailsScreenProps {
  navigation: any;
}
        ...
        <View style={styles.inputContainer}>
          ...
          <View>
            ...
            <View style={{marginTop: '4%', marginLeft: 3, marginRight: 3}}>
              <TextField
                placeholder={'Select Starting year of standard'}
                imageIcon={Images.calendar_icon}
                editable={false}
              />
            </View>
            ...
            <View style={{marginTop: '5%', marginLeft: 3, marginRight: 3}}>
              <TextField
                placeholder={'Select Ending year of standard'}
                imageIcon={Images.calendar_icon}
                editable={false}
              />
            </View>
            ...
            <View
              ...
              <Image
                ...
                style={styles.checkbox}></Image>
              <View style={{marginLeft: 15, marginTop: 5}}>
                <Text style={styles.fillText_Add}>Add Standard</Text>
              </View>
            </View>
          </View>
