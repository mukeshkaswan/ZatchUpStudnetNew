  ...
  const rednderItemList = (item, index) => {
    return (
      <>
        ...
        {item.educationdetail.length > 0 && item.educationdetail.map(i => {
          return (
            <CardView
              cardElevation={1}
              cardMaxElevation={1}
              ...
              <View>
                ...
                <View style={styles.view_Row}>
                  ...
                  /> : null}
                  <Text style={{ marginTop: 5, fontSize: 18, marginLeft: 10, color: '#565656', flex: 1, flexWrap: 'wrap' }}>{i.name_of_school}</Text>
                ...
                <View style={styles.view_Row}>
                  ...
                  <Text style={styles.view_Tv_2}>{i.address1 + " " + i.address2}</Text>
                </View>
              ...
              {i.course_detail && i.course_detail.map(course => {
                return (<View>
                  <View style={styles.view_Row}>
                  ...
                  <View style={styles.view_Row}>
                    ...
                    <Text style={styles.view_Tv_2}>{course.course_name}</Text>

                  </View>

                  {course.is_current_course == true ? <View style={styles.view_Row}>
                    <Text style={styles.view_Tv_1}>Course Duration :</Text>
                    <Text style={styles.view_Tv_2}>{course.start_year + '-' + 'Current'}</Text>
                  </View> :
                    <View style={styles.view_Row}>
                      <Text style={styles.view_Tv_1}>Course Duration :</Text>
                      <Text style={styles.view_Tv_2}>{course.start_year + i.end_year}</Text>
                    </View>}

                  <View style={styles.view_Row}>
                    <Text style={styles.view_Tv_1}>Course Tenure :</Text>
                    <Text style={styles.view_Tv_2}>{course.duration}</Text>
                  </View>
                  ...
                  {course.standard_detail && course.standard_detail.map(standard => {
                    return (<View>
                      <Text style={styles.Personal_Tv}>Standard Details</Text>
                      <View
                        style={styles.underview}
                      />

                      {standard.is_current_standard == true ? <View style={styles.view_Row}>
                        <Text style={styles.view_Tv_1}>Standard :</Text>
                        <Text style={styles.view_Tv_2}>{standard.standard_name + ' ' + '(' + standard.standard_start_year + '-' + 'To Current'}</Text>
                      </View> :
                        <View style={styles.view_Row}>
                          <Text style={styles.view_Tv_1}>Standard :</Text>
                          <Text style={styles.view_Tv_2}>{standard.standard_name + '-' + standard.standard_end_year}</Text>
                        </View>}

                      {standard.class_detail && standard.is_current_standard == true ? <View>
                        {standard.class_detail.map(class_i => {
                          return (<View>
                            ...
                            <View style={styles.view_Row}>
                              ...
                              <Text style={styles.view_Tv_2}>{class_i.roll_no}</Text>
                            </View>
                          </View>
        ...
        <View>
          <View style={[styles.avatarStyle, { borderRadius: 45 }]}>
            <Image source={{ uri: profilepic }}
              style={{ height: '100%', width: '100%', resizeMode: 'cover', borderRadius: 45 }} />
            {kyc_approved == '1' ? <View style={{ height: 30, width: 30, borderRadius: 15, position: 'absolute', right: 0 }}>
              <Image source={Images.blue_tick}
                style={{ height: '100%', width: '100%', resizeMode: 'cover', }} />
            </View> : null}
          </View>
        </View>
        <Text style={styles.textStyle} >{username}</Text>
        <Text style={styles.textStyle_} >{'Unique ZatchUp ID' + ':' + zatchupid}</Text>
      </View>
      ...
      <ScrollView>
        ...
        <View style={styles.view}>
          ...
          <CardView
            ...
            {gender == 'M' ? <View style={styles.view_Row_}>
              <Text style={styles.view_Tv_1}>Gender :</Text>
              <Text style={styles.view_Tv_2}>Male</Text>
            </View> : gender == 'F' ? <View style={styles.view_Row_}>
              <Text style={styles.view_Tv_1}>Gender :</Text>
