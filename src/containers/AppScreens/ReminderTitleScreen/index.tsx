...
const ReminderTitleScreen= (props: ResetPasswordScreenProps) => {
  ...
  const renderIndicator = () => {
    ...
    <HeaderTitleWithBack
          ...
          headerTitle="Reminder Title"
        />

<View style={{width:'100%',alignSelf:'center',paddingHorizontal:10,marginTop:10}}> 
<Image
              source={Images.reminder} //Change your icon image here
              style={{
                // padding: 10,
                marginTop: 10,
                    width:'100%',
 ...
 <View style={{marginTop:15,paddingHorizontal:15,alignSelf:'center'}}>
    ...
    Lorem Ipsum is simply dummy text of the printing and type setting industry setting.
