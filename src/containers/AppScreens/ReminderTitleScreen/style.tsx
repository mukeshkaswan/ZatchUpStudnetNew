...
container: {
     ...
     reminderrowcontainer:{
        width:'100%',backgroundColor:'white',marginTop:18,borderRadius:15,flexDirection:'row',justifyContent:'space-between',alignItems:'center',height:hp('8'),paddingLeft:15,elevation:5
      },
