...
//export const BaseURL = `https://apis.zatchup.com:3000/api/`; //Prod last one
//export const ChatURL = `https://zatchup.com/preprod/#/`; //Preprod Chat URL
//export const ChatURL = `https://zatchup.com/#/`; //Prod Chat URL last one
//export const ChatURL = `http://staging.zatchup.com/zatchup/#`;//Staging Chat URL


export const BaseURL = `https://demo.zatchup.com:3000/api/`; 
export const ChatURL = `https://demo.zatchup.com/#/`; // Chat URL
